...
#' | resource_type | character scalar | The base type of this resource. |
#' | created_at | datetime scalar | The time at which this resource was created. |
#' | html_text | character scalar | [Opt In](https://developers.asana.com/docs/inputoutput-options). HTML formatted text for a comment. This will not include the name of the creator. |
...
#' | created_at | datetime scalar | The time at which this resource was created. |
#' | dependencies | list | [Opt In](https://developers.asana.com/docs/inputoutput-options). Array of resources referencing tasks that this task depends on. The objects contain only the gid of the dependency. |
#' | dependents | list | [Opt In](https://developers.asana.com/docs/inputoutput-options). Array of resources referencing tasks that depend on this task. The objects contain only the ID of the dependent. |
...
#' | external | list | *OAuth Required*. *Conditional*. This field is returned only if external values are set or included by using [Opt In](https://developers.asana.com/docs/inputoutput-options). The external field allows you to store app-specific metadata on tasks, including a gid that can be used to retrieve tasks and a data blob that can store app-specific character strings. Note that you will need to authenticate with Oauth to access or modify this data. Once an external gid is set, you can use the notation `external:custom_gid` to reference your object anywhere in the API where you may use the original object gid. See the page on Custom External Data for more details. |
...
#' | html_notes | character scalar | [Opt In](https://developers.asana.com/docs/inputoutput-options). The notes of the text with formatting as HTML. |
#' | is_rendered_as_separator | logical scalar | [Opt In](https://developers.asana.com/docs/inputoutput-options). In some contexts tasks can be rendered as a visual separator; for instance, subtasks can appear similar to [sections](https://developers.asana.com/reference/sections) without being true `section` objects. If a `task` object is rendered this way in any context it will have the property `is_rendered_as_separator` set to `true`. |
...
#' | num_subtasks | integer scalar | [Opt In](https://developers.asana.com/docs/inputoutput-options). The number of subtasks on this task.  |
